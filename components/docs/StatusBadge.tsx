...
const STYLE: Record<StatusLevel, { fg: string; bg: string; border: string; dot: boolean }> = {
  ...
  wired: { fg: "var(--color-quantum-text)", bg: "color-mix(in oklab, var(--color-quantum) 12%, transparent)", border: "color-mix(in oklab, var(--color-quantum) 34%, transparent)", dot: false },
